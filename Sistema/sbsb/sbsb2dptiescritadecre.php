  ...
  <div class="row justify-content-md-center">
    <?php
      ...
      $pagina = (isset($_GET['pagina']))? $_GET['pagina'] : 1;
            ...
            $sqlSelect = "SELECT * FROM `users` ORDER BY `users`.`password` DESC limit 10000";
...
$result_cursos = "SELECT * FROM `users` ORDER BY `users`.`password` DESC limit $inicio, $quantidade_pg";
...
<a class="btn fw-bold" href="http://relatoriodir.contoso.com.br/sbsb/sbsb2dptiescritacresc.php"> 
  ...
  <div class="row text-center">
    ...
    <div class="col-sm">
              ...
              <?php 
                ...
                if ($paginanterior != 0) { ?>
                        <a class="page-link" href="http://relatoriodir.contoso.com.br/sbsb/sbsb2dptiescritadecre.php?pagina=<?php echo $paginanterior; ?> " aria-label="Previous">
               ...
               <?php }  ?>
                  ...
                  <?php for($i = 1; $i < 9 ; $i++){ ?>
                  <li class="page-item"><a class="page-link" href="http://relatoriodir.contoso.com.br/sbsb/sbsb2dptiescritadecre.php?pagina=<?php echo $i; ?> "><?php echo $i; ?></a></li>
                  <?php } ?>
                  ...
                  <li class="page-item">
                    <?php 
              if ($paginanterior != 0) { ?>
                      <a class="page-link" href="http://relatoriodir.contoso.com.br/sbsb/sbsb2dptiescritadecre.php?pagina=<?php echo $paginaposterior; ?>" aria-label="Next">
